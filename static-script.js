// Resume Builder Application - Static Version for GitHub Pages
...
// Static AI Suggestions (without backend)
function getAISuggestions(section) {
    const staticSuggestions = {
        overall: [
            "Ensure your resume is concise and fits on 1-2 pages maximum",
            "Use consistent formatting and professional fonts throughout",
            "Include quantifiable achievements with specific numbers and metrics"
        ],
        summary: [
            "Start with your years of experience and key expertise areas",
            "Include 2-3 specific achievements that demonstrate your value",
            "Use action-oriented language and industry-relevant keywords"
        ],
        experience: [
            "Begin each bullet point with strong action verbs (achieved, managed, improved)",
            "Quantify your accomplishments with percentages, dollar amounts, or numbers",
        ...
        skills: [
            ...
            "Include skill levels (beginner, intermediate, advanced) where relevant",
